...
public class AnimeRepository @Inject constructor(private val apolloClient: ApolloClient) {
    ...
    public suspend fun getTrendingAnime(page: Int = 1, perPage: Int = 20, showAdult: Boolean = false): Unit = withContext(Dispatchers.IO) {
        val response = apolloClient.query(GetTrendingAnimeQuery(page, perPage, Optional.presentIfNotNull(showAdult))).execute()
