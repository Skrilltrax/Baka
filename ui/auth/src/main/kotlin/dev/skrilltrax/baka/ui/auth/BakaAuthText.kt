...
fun BakaAuthTitleText(text: String, modifier: Modifier = Modifier) {
    val titleStyle = MaterialTheme.typography.displayLarge.copy(color = Color.White)
    Text(text = text, modifier = modifier, style = titleStyle)
}

@Composable
fun BakaAuthSubtitleText(text: String, modifier: Modifier = Modifier) {
    val titleStyle = MaterialTheme.typography.titleLarge.copy(color = Color.White)
    Text(text = text, modifier = modifier, style = titleStyle)
}

@Composable
fun BakaAuthLabelText(text: String, modifier: Modifier = Modifier) {
    val titleStyle = MaterialTheme.typography.bodySmall.copy(color = Color.White)
    Text(text = text, modifier = modifier, style = titleStyle)
}
